    ...
    <div className='scrapify-page'>
      <div className='upload-grid'>
        ...
        <div className='right-grid'>
          ...
          <div className='u-img-desc'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos
            voluptatem deleniti fugiat vero perspiciatis labore ipsum atque
            culpa vel, quasi nulla totam placeat magnam numquam earum,
            consequuntur neque. At, dicta.
          </div>
          <div className='u-img-head'>Attributes</div>
          <div className='attributes'>
            <div className='attribute'>Attribute01</div>
            <div className='attribute'>Attribute02</div>
            <div className='attribute'>Attribute03</div>
            <div className='attribute'>Attribute04</div>
            <div className='attribute'>Attribute05</div>
            <div className='attribute'>Attribute06</div>
          </div>
