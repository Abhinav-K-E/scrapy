...
import DUMMY from '../../assets/scrap.jpg'
    ...
    <div className='database-page'>
      ...
      <div className="database-cards">
        <div className="database-card">
          <img src={DUMMY} alt='img' className="card-left"/>
          <div className="card-right">
            <div className="card-name">
              Product
            </div>
            <div className="short-desc">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi voluptas laboriosam magnam expedita cumque. Distinctio?
            </div>
